...
calc_pts_won_obj,
sideout_rate_obj,
sideout_rate_opp_obj,
run_burden_obj,
run_burden_exp_obj,
run_burden_resid_obj,
run_hazard_obj,
)
...
def build_metric_namespace(ppr_df, player_name):
  ...
  return {
    ...
    'sideout_rate_obj'       : sideout_rate_obj,
    'sideout_rate_opp_obj'   : sideout_rate_opp_obj,
    'run_burden_obj'         : run_burden_obj,
    'run_burden_exp_obj'     : run_burden_exp_obj,
    'run_burden_resid_obj'   : run_burden_resid_obj,
    'run_hazard_obj'         : run_hazard_obj,
