from ._anvil_designer import player_ci_reportTemplate
from anvil import *
import anvil.server
...
class player_ci_report(player_ci_reportTemplate):
  def __init__(self, report_id=None, **properties):
    ...
    header_label = Label(
      text="Beach Internals, scott@beachinternals.com", foreground="black", font_size=16
    )
