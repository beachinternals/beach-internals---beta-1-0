...
class Dashboard(DashboardTemplate):
  ...
  def gen_dashboard_button_click(self, **event_args):
    ...
    self.rich_text_2.content, self.rich_text_3.content, self.rich_text_4.content = anvil.server.call('coaches_dashboard', self.league_drop_down.selected_value, user_row['team'])
