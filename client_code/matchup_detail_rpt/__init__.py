...
class matchup_detail_rpt(matchup_detail_rptTemplate):
  def __init__(
    ...
    **properties,
    ...
    self.attack_b1_label.text = box_title1 + player_b1
    self.attack_b2_label.text = box_title2 + player_b2

    self.attack1_mkdn.content = table_data1
    self.attack2_mkdn.content = table_data2
